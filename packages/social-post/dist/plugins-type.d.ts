import { BlockTool, BlockToolConstructable, BlockToolConstructorOptions } from '@editorjs/editorjs';
...
export declare type SocialPostPluginConstructorOptions = BlockToolConstructorOptions<SocialPostPluginData>;
